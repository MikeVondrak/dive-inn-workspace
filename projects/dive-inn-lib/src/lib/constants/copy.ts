export const copy = {
  reservations: {
    email: {
      ...
      requestReceived: 'We have received your request, and you will receive another email confirming your reservation, usually within 24-48 hours (please reach out if you do not hear from us).',
      weatherGroupSize: 'Your dedicated space for the event will depend on your group size and the weather.',
      features: {
        header: 'Features:', 
        noCharge: 'NO charge to rent the space!',
        noDrinkMin: 'NO drink minimums!',
        under21til6: 'Under 21 allowed until 6:00 PM',
        boatGroup13: 'Groups up to 13 people in the Boat, and larger spaces for parties of 15-250+',
      },
      ...
      doNots: {
        ...
        noReserveGames: 'No reserving games (pool, ping pong, cornhole) - first come, first serve!',
